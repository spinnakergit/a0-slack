"""Plugin lifecycle hooks for the Slack Integration plugin.
...
def install(**kwargs):
    ...
    # 3. Create symlink so 'from plugins.slack.helpers...' imports work
...
def uninstall(**kwargs):
    ...
    # Remove skills
    skills_dst = a0_root / "usr" / "skills"
    for skill_name in ['slack-chat', 'slack-communicate', 'slack-manage', 'slack-research', 'slack-search']:
